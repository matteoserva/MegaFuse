...
SRC = src/megacli.cpp src/megafusecallbacks.cpp src/fuse.c  src/megafuse.cpp src/megaposix.cpp src/Config.cpp sdk/megabdb.cpp src/megaclient.cpp sdk/megacrypto.cpp src/fuseImpl.cpp
